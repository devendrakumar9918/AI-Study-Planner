...
plan = plan.replace(/^#.*AI Study Plan.*$/gm, "").trim();

document.getElementById("study-plan").innerHTML = `
<div class="plan-card">
    <h3>📅 AI Study Plan</h3>
    <pre class="study-plan-text">${plan}</pre>
</div>`;
...
async function exportPDF() {
    ...
    let plan = document.querySelector(".study-plan-text");
...
doc.setFontSize(12);
doc.text("Your Personalized Study Schedule",20,30);
...
doc.line(20,35,190,35);
    ...
    lines.forEach(line => {
        ...
        doc.roundedRect(18, y-5, 174, 8, 2, 2);
    ...
    doc.text("Generated by AI Study Planner",20,285);
    doc.setFontSize(10);
